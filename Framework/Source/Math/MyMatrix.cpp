...
void MyMatrix::SetAxesView(const vec3& right, const vec3& up, const vec3& at, const vec3& pos)
{
...
void MyMatrix::SetAxesWorld(const vec3& right, const vec3& up, const vec3& at, const vec3& pos)
{
...
void MyMatrix::SetTranslation(vec3 pos)
{
    m41 = pos.x;
    m42 = pos.y;
    m43 = pos.z;
...
void MyMatrix::CreateScale(vec3 scale)
{
    m12 = m13 = m14 = m21 = m23 = m24 = m31 = m32 = m34 = m41 = m42 = m43 = 0;
    m11 = scale.x;
    m22 = scale.y;
...
void MyMatrix::CreateRotation(vec3 eulerdegrees)
{
    SetIdentity();
...
void MyMatrix::CreateTranslation(vec3 pos)
{
    m12 = m13 = m14 = m21 = m23 = m24 = m31 = m32 = m34 = 0;
    m11 = m22 = m33 = m44 = 1;
    m41 = pos.x;
...
void MyMatrix::CreateSRT(float scale, vec3 rot, vec3 pos)
{
    SetIdentity();
    Scale(scale);
...
void MyMatrix::CreateSRT(vec3 scale, vec3 rot, vec3 pos)
{
...
void MyMatrix::Scale(vec3 scale)
{
...
void MyMatrix::TranslatePreRotScale(vec3 translate)
{
...
void MyMatrix::Translate(vec3 pos)
{
    m41 += pos.x;
    m42 += pos.y;
    m43 += pos.z;
...
void MyMatrix::CreateLookAtView(const vec3& eye, const vec3& up, const vec3& at)
{
#if MYFW_RIGHTHANDED
...
void MyMatrix::CreateLookAtWorld(const vec3& objpos, const vec3& up, const vec3& at)
{
